...
output_path3="/media/jaume/DATA/Data/fomo25/fomo-task3-val/predictions_validator_ft_dino_bias"
...
# start_time=$(date +%s)
# python main.py --task task3 --container ${task3_img} --data-dir ${data_path}/fomo-task3_small/ --output-dir ${output_path3}
# end_time=$(date +%s)
# elapsed=$((end_time - start_time))
...
# eval_output="/media/jaume/DATA/Data/fomo25/fomo-task3-val/eval_results_ft_dino"
